...
public interface IncomeDao extends JpaRepository<Income, Long>, QueryDslPredicateExecutor<Income> {
    ...
    List<Income> findIncomeByPolozkaString(@Param("i") int i, @Param("cisloSubstring") String cisloSubstring, @Param("selectedCity") String selectedCity, @Param("selectedMonth") String selectedMonth, @Param("selectedYear") String selectedYear);
